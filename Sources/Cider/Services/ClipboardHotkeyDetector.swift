...
final class ClipboardHotkeyDetector: @unchecked Sendable {
    ...
    func start() {
        ...
        eventTap = CGEvent.tapCreate(
            ...
            callback: { proxy, type, event, refcon in
                ...
                let detector = Unmanaged<ClipboardHotkeyDetector>.fromOpaque(refcon).takeUnretainedValue()
    ...
    private static let signature: OSType = 0x434C5659 // "CLVY"
    ...
    private func registerHotKeyFallback() -> Bool {
        ...
        let status = InstallEventHandler(
            ...
            { _, eventRef, userData in
                ...
                let d = Unmanaged<ClipboardHotkeyDetector>.fromOpaque(userData).takeUnretainedValue()
