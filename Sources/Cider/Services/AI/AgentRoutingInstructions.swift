...
enum AgentRoutingInstructions {
    ...
    - For bookmark capture, prefer saving the raw URL to the chosen destination without overriding the title; let Cider perform native title and thumbnail enrichment after save.
    ...
    - After a bookmark exists, AI may add AI-owned enrichment such as aiSummary, but should not invent replacement titles for opaque URLs.
