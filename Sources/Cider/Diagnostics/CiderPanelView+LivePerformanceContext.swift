...
extension CiderPanelView {
    ...
    var livePerformanceContext: CiderLivePerformanceContext {
        ...
        case .home, .reviewQueue, .libraryDashboard, .projectsHome, .projectOverview, .projectInbox, .projectSurface, .spacesOverview, .spacesManager, .agentRooms, .aiAssistant, .journal:
