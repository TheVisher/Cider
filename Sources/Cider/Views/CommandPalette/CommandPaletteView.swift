        ...
        ZStack {
            ...
            VStack(spacing: 0) {
                ...
                PaletteContentArea(
                    ...
                    bookmarkFolders: viewModel.bookmarkFolders,
                    bookmarkDisplayMode: viewModel.bookmarkDisplayMode,
                    bookmarkCardSize: viewModel.bookmarkCardSize,
                    onBookmarkDisplayModeChange: { viewModel.setBookmarkDisplayMode($0) },
                    onBookmarkCardSizeChange: { viewModel.setBookmarkCardSize($0) },
                    ...
                    onAssignBookmarkToFolder: { viewModel.assignBookmark($0, toFolder: $1) },
                    onCreateBookmarkFolder: { viewModel.createBookmarkFolder(name: $0, parentID: $1) },
