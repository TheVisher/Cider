...
extension Notification.Name {
    ...
    static let togglePanelDock = Notification.Name("cider.togglePanelDock")
    static let panelDockStateChanged = Notification.Name("cider.panelDockStateChanged")
    static let panelFolderSelected = Notification.Name("cider.panelFolderSelected")
