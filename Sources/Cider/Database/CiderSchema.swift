...
enum CiderSchema {
    ...
    static let createIndexes: [String] = [
        ...
        "CREATE INDEX IF NOT EXISTS idx_routing_decisions_owner ON routing_decisions(owner_type, owner_id, created_at);",
        "CREATE INDEX IF NOT EXISTS idx_routing_decisions_status ON routing_decisions(status, created_at);",
