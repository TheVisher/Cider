...
- Kanban should optimize for scanning and handoff. Projects opens to a calm cross-project summary of Active, Testing, Blocked, and Next Up work. Entering one project opens its Board; a concise Overview remains secondary. Call unread/unreviewed project work **Updates**, not another Inbox, and expose it through quiet needs-attention badges. Consolidate Docs, Decisions, QA, and Plans into one Project Docs section with filters instead of four permanent tabs.
