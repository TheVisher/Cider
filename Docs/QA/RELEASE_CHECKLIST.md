...
- [UI/UX Compliance](#uiux-compliance-acrylic-style)
- [Floating Panel QA](#floating-panel-qa)
- [Title Bar QA](#title-bar-qa)
- [Bookmarks QA](#bookmarks-qa)
- [Notes Editor QA](#notes-editor-qa)
- [Notes Editor Smoke Checklist](#notes-editor-smoke-checklist)
- [Settings QA](#settings-qa)
- [Platform QA](#platform-qa)
- [Accessibility QA](#accessibility-qa)
- [Performance](#performance)
- [Marketing Readiness](#marketing-readiness)
- [QA Testing Plan](#qa-testing-plan)
...
## Notes Editor QA
- [ ] Run the Notes Editor Smoke Checklist (below) end-to-end.
...
Creating, editing, and managing notes. Reference the Notes Editor Smoke Checklist (above) for deeper editor tests.
